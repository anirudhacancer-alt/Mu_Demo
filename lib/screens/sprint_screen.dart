    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // NOTE: not const — subtitle interpolates a runtime value
          // (sprint.currentSprint.length), so this widget cannot be a
          // compile-time constant.
          SectionHeader(title: 'Current Sprint', subtitle: '${sprint.currentSprint.length} tasks in flight'),
